...
You will need to create a database with data about ... and write procedures and functions to retrieve information, as well as procedures and triggers to change it.
